...
if __name__ == '__main__':
    # parameters
    src_dir='../Data/time/high'
    save_dir = '../Data/npy_data/'
    file_list = load_image_from_dir('../Data/time/high')
    num_threads = 16
    num_threads = 1
...
if not args.only_test:
    save_dir = './save_'+ args.model + '_' + 'sigma' + str(args.sigma) + '_' + time.strftime("%Y-%m-%d-%H-%M-%S", time.localtime()) + '/'
    if not os.path.exists(save_dir):
        os.mkdir(save_dir)
    # log
